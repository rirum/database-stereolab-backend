...
var fitFor_router_exports = {};
__export(fitFor_router_exports, {
  fitForRouter: () => fitForRouter
});
module.exports = __toCommonJS(fitFor_router_exports);
...
// src/routes/fitFor-router.ts
var fitForRouter = (0, import_express.Router)();
