...
var category_router_exports = {};
__export(category_router_exports, {
  categoryRouter: () => categoryRouter
});
module.exports = __toCommonJS(category_router_exports);
...
// src/routes/category-router.ts
var categoryRouter = (0, import_express.Router)();
