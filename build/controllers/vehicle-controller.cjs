...
var vehicle_controller_exports = {};
__export(vehicle_controller_exports, {
  createBrand: () => createBrand2,
  getAllBrands: () => getAllBrands3,
  getAllModels: () => getAllModels3,
  getAllVersions: () => getAllVersions3,
  getModelsByVehicleId: () => getModelsByVehicleId2,
  getVersionByModelId: () => getVersionByModelId3,
  registerModel: () => registerModel3,
  registerVersion: () => registerVersion3
});
module.exports = __toCommonJS(vehicle_controller_exports);
